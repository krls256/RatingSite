...
/* harmony import */ var _user_reCaptcha__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./user/reCaptcha */ "./resources/js/user/reCaptcha/index.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_user_reCaptcha__WEBPACK_IMPORTED_MODULE_7__["default"])();
});
...
/***/ "./resources/js/user/reCaptcha/index.js":
/*!**********************************************!*\
  !*** ./resources/js/user/reCaptcha/index.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var protectEachForm = function protectEachForm() {
  var ReCaptchaKey = document.querySelector('meta[name="g-recaptcha"]').content;
    ...
    form.addEventListener('submit', function (e) {
      ...
      grecaptcha.ready(function () {
        grecaptcha.execute(ReCaptchaKey, {
          ...
          var el = "<input name=\"g-recaptcha-response\" value=\"".concat(token, "\" type=\"hidden\"/>");
...
/* harmony default export */ __webpack_exports__["default"] = (protectEachForm);
