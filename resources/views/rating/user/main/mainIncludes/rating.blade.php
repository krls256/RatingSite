<section class="rating pt-6">

    <ul class="rating__list">
    @foreach($companies as $k => $company)
      <li class="rating__list-item">
          <a href="{{ route('rating.user.companies', $company->company_slug) }}" @if($k < 3) class="rating__link rating__link--first" @else class="rating__link" @endif>
              ...
              <div @if($k <= 3) class="rating__mail rating__mail--first" @else class="rating__mail" @endif  >
              </div>
          </a>
      </li>
    @endforeach
